...
class Menu: BaseClass {
    ...
    var arraySideMenu = [SideMenu(title: "Home", image: #imageLiteral(resourceName: "home")),SideMenu(title: "My Profile", image: #imageLiteral(resourceName: "user")),SideMenu(title: "History", image: #imageLiteral(resourceName: "history")),SideMenu(title: "Appointment", image: #imageLiteral(resourceName: "appointment")),SideMenu(title: "Portfolio", image: #imageLiteral(resourceName: "favourites")),SideMenu(title: "Messages", image: #imageLiteral(resourceName: "message")),SideMenu(title: "Notifications", image: #imageLiteral(resourceName: "notification")),SideMenu(title: "Settings", image: #imageLiteral(resourceName: "setting"))]
    let storyboardIds = ["HomeVC", "ProfileVC", "HistoryListID", "MyAppointmentID", "PortFolioVC", "MessagesListID", "NotificationListID", "SettingsID"]
    ...
    @IBAction func goToProfileTapGestureAction(_ sender: UITapGestureRecognizer) {
        ...
        let objVC = storyboard?.instantiateViewController(withIdentifier: "ProfileVC")
